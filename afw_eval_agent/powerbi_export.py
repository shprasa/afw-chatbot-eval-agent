"""Clean Power BI export from workspace runs — auto-refreshes after each eval."""
...
"""
    (out_dir / "POWERBI_Setup_Guide.md").write_text(guide, encoding="utf-8")
