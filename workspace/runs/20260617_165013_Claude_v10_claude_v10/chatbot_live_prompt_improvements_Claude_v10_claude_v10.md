...
- recall `eligible`: n/a
- top confusion: truth `insufficient_information` predicted `manual_review` (3)
- most frequent divergence checkpoint: q7 (3)
...
### insufficient_information → manual_review (3 failures)
