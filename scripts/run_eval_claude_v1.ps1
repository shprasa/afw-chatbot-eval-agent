...
#
# Run:  .\run_original_style_short_claude_v1.ps1
# Resume:  .\run_original_style_short_claude_v1.ps1 -Resume
...
$transcript = Join-Path (Split-Path $PSScriptRoot -Parent) "artifacts\chatbot_live_transcripts_original_style_short_claude_v1.jsonl"
...
$env:CHATBOT_OUTPUT_SUFFIX = "_original_style_short_claude_v1"
$env:CHATBOT_SOURCE_TAG = "original_style_short_f_claude_v1"
